...
# Importa todos os modelos para que o Alembic detecte as tabelas automaticamente.
...
# Define os metadados que serão usados para autogenerate de migrations.
...
async def run_async_migrations() -> None:
    """Executa migrations no modo online usando engine assíncrona."""
